...
//		scheduleJob(getJobInfo());
		boolean isLocalServiceWork = isServiceWork(this, "com.gdj.studyoptimize.keeplive.LocalService");
		boolean isRemoteServiceWork = isServiceWork(this, "com.gdj.studyoptimize.keeplive.RemoteService");
...
//		Toast.makeText(this, "process stop", Toast.LENGTH_SHORT).show();
	...
	public JobInfo getJobInfo(){
		...
		builder.setRequiredNetworkType(JobInfo.NETWORK_TYPE_ANY);//任何网络情况都开启
		builder.setPersisted(true);
		builder.setRequiresCharging(false);  //充电
		builder.setRequiresDeviceIdle(false);//设备比较闲
		builder.setPeriodic(1000000);//间隔时间--周期  ,用的时候写的很大的值,否则很耗电
